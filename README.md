...
<h3 align="center">Una graduada en ingeniería informática creciendo como desarrolladora web y de apps de escritorio</h3>

- 🌱 En proceso de aprendizaje de **Delphi** y **SQL Server**.
  
- ✨ Mejorando skills en **Next JS, Javascript, CSS** y algunas tecnologías de **desarrollo web**.

- 💬 Puedes preguntarme sobre **HTML, Tailwind, Typescript, React** y **React Native**.
